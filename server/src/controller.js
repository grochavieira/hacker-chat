...
export default class Controller {
  ...
  async joinRoom(socketId, data) {
    ...
    // avisa a rede que o novo usuário se conectou
    this.broadcast({
      socketId,
      roomId,
  ...
  // função para adicionar usuário em uma sala específica
  // utilizando Map()
  ...
  #onSocketData(id) {
    return (data) => {
      try {
        ...
        this[event](id, message); // é utilizado para trabalhar com diferentes eventos
      } catch (error) {
