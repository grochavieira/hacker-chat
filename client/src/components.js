// classe responsável por construir a interface sob demanda
...
export default class ComponentsBuilder {
  ...
  setLayoutComponent() {
    // criar varias janelas dentro de uma só
  ...
  setActivityLogComponent() {
    this.#activityLog = blessed.list({
      ...
      items: ["{bold}Registro de Atividades{/}"],
    });
